...
=======
	...
	export const GIT_ASKPASS: string;
	export const VSCODE_GIT_ASKPASS_NODE: string;
	export const npm_package_dependencies_tailwind_scrollbar_hide: string;
	...
	export const NODE_ENV: string;
>>>>>>> 4a50df2cf14e9d3ffcff5a7f13b34c6a4ed91af3
}
...
=======
		...
		GIT_ASKPASS: string;
		VSCODE_GIT_ASKPASS_NODE: string;
		npm_package_dependencies_tailwind_scrollbar_hide: string;
