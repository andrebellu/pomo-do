<script>
    ...
    function done(id) {
        ...
        let endpoint_done = "http://127.0.0.1:5000/tasks/" + id;
        ...
        fetch(endpoint_done, options).then((response) => response.json());
    }
</script>
    ...
    <div class="card-body items-center text-center flex-wrap">
        ...
        <div class="card-actions justify-end">
            <div class="btn-group">
                ...
                <button class="btn btn-primary" on:click={() => done(todo[0])}
                    >Done</button
                >
            </div>
        </div>
